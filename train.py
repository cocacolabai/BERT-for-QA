      ...
      for article in json.load(f)['data']:
        ...
        ###########################
          ...
          for qa in para['qas']:
            ...
            self.data.append((qa_id, context, question, doc_tokens, orig_answer_text, start_position, end_position, answerable))
  
  def __len__(self) -> int:
    return len(self.data)

  def __getitem__(self, index: int):
    qa_id, context, question, doc_tokens, orig_answer_text, start_position, end_position, answerable = self.data[index]
    return qa_id, context, question, doc_tokens, orig_answer_text, start_position, end_position, int(answerable)
